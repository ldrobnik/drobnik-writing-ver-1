...
const APP_ROUTES: Routes = [
    ...
    {path: 'nocturine', component: TextNocturine3Component, data: {title: 'Łukasz Drobnik - Nocturine (fragment)', theme: 0}},
    ...
    {path: 'nocturine/en', component: TextNocturine3EnComponent, data: {title: 'Łukasz Drobnik - Nocturine (fragment)', theme: 0}},
    {path: 'cunninghamella', component: TextCunninghamella1Component, data: {title: 'Łukasz Drobnik - Cunninghamella (fragment)', theme: 1}},
    ...
    {path: 'cunninghamella/en', component: TextCunninghamella1EnComponent, data: {title: 'Łukasz Drobnik - Cunninghamella (fragment)', theme: 1}},
    {path: 'vostok', component: TextVostok1Component, data: {title: 'Łukasz Drobnik - Vostok - Rozdział pierwszy', theme: 2}},
    ...
    {path: 'vostok/en', component: TextVostok1EnComponent, data: {title: 'Łukasz Drobnik - Vostok - Chapter One', theme: 2}},
